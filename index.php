...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO uheads_data(reference_id, n_add, n_send, u_address, u_document, u_dor, u_filing, u_sub, u_unit, process_owner, image, uploaded) VALUES ('$reference_id','$n_add','$n_send','$u_address','$u_document','$u_dor','$u_filing','$u_sub','$n_add','$process_owner','$image',NOW())";
...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
		<h2 class="mb-4 dashboard">Document Management</h2>
		...
		<!-- adding alert notification  -->
			...
			<div class="center">
				<div class="box">
					...
					<div class="item-2">
						<button class="btn btn-info add" type="button" data-toggle="modal" data-target="#myModal">
			...
			<br><br>
				...
				<table class="table table-sm table-striped table-hover table-responsive" id="myTable">
					<thead>
						<tr>
        				...
        				while($row = mysqli_fetch_array($run_data))
        				{
							...
							<tr>
								...
								<td class='text-center actions' style='display:flex; align-items: center; justify-content: center; '>
										...
										<a href='#' target='_blank' class='btn btn-success mr-1 Print' title='Print' style='margin-bottom: 5px; '>
											<i class='bi bi-printer-fill' data-target='#print$id' aria-hidden='true'></i>
										</a>
									
									<span style='display:flex; align-items: center; justify-content: center; margin-left: 1px; '>
										<a href='#' class='btn btn-warning mr-1 Edit' data-toggle='modal' data-target='#edit$id' title='Edit' style='margin-bottom: 5px; margin-right: 5px; '>
											<i class='bi bi-pencil-square' aria-hidden='true'></i>
										</a>

										<a href='#' class='btn btn-danger mr-1 Delete' title='Delete' style='margin-bottom: 5px; '>
							...
							<div class="modal-body">
								<form method="POST" enctype="multipart/form-data">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="subject">Date of Receipt</label>
											<input type="date" class="form-control" name="user_dor" placeholder="Date of Receipt">
										</div>
										<div class="form-group col-md-6">
											<label for="process"> Process Owner </label><br>
											<select id="process_Owner" name="p_owner" class="form-control">
													<option selected> -- Select -- </option>
													<option value="Research and Development">Research and Development</option>
													<option value="Extension &Technical Advisory Services">Extension &Technical Advisory Services</option>
													<option value="Office of the Students Affairs">Office of the Students Affairs</option>
													<option value="Library">Library</option>
													<option value="Supply">Supply</option>
													<option value="Registrar Services">Registrar's Services</option>
													<option value="Admission and Placement Process">Admission and Placement Process</option>
													<option value="Guidance and Counselling">Guidance and Counselling</option>
													<option value="Information and Technology Office and Computer Laboratory">Information and Technology Office and Computer Laboratory</option>
													<option value="Physical Plant & Facilities">Physical Plant & Facilities</option>
													<option value="Security Services">Security Services</option>
													<option value="Health Services (Medical and Dental)">Health Services (Medical and Dental)</option>
													<option value="Admin Coordinator/BAC">Admin Coordinator/BAC</option>
													<option value="TES/Scholarship/Teller">TES/Scholarship/Teller</option>
											</select>
										</div>
									</div>
											...
											<div class='form-row'>
												...
												<div class='form-group col-md-6'>
													...
													<select id='process_Owner' name='p_owner' class='form-control'>
															...
															<option value='Library'>Library</option>
															<option value='Supply'>Supply</option>
															<option value='Registrar's Services'>Registrar's Services</option>
															<option value='Admission and Placement Process'>Admission and Placement Process</option>
															<option value='Guidance and Counselling'>Guidance and Counselling</option>
															<option value='Information and Technology Office and Computer Laboratory'>Information and Technology Office and Computer Laboratory</option>
															<option value='Physical Plant & Facilities'>Physical Plant & Facilities</option>
