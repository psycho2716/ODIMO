...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
		<h2 class="mb-4 dashboard" style="font-family:'Bebas Neue', cursive; ">Admin Coordinator/BAC</h2>
			...
			<br><br>
				...
				<table class="table table-md table-striped table-hover table-responsive" id="myTable">
					...
					<?php 
        				...
        				$get_data = "SELECT * FROM uheads_data WHERE process_owner = 'Admin Coordinator/BAC'";
