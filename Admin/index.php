    ...
    <div id="content" class="p-4 p-md-5 pt-5">
		...
		<!-- adding alert notification  -->
			...
			<div class="center">
				<div class="box">
					<div class="item-1">
						<form class="exp_btn" method="post" action="../Admin/export.php">
				...
				<div class="print_btn" style="display: none; ">
					<a href="../Admin/print.php" target="_blank" class=" btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>
				</div>
			</div>
			...
			<br><br>
				...
				<table class="table table-sm table-striped table-hover table-responsive" id="myTable">
					...
					<?php
        				...
        				$get_data = "SELECT * FROM document_data order by 1 desc";
							...
							<tr>
								...
								<td class='text-center actions' style='display:flex; align-items: center; justify-content: center; '>
									...
									<span style='display:flex; align-items: center; justify-content: center; margin-left: 1px; '>
										<a href='#' class='btn btn-warning mr-1 Edit' title='Edit' style='margin-bottom: 5px; margin-right: 5px; '>
											<i class='bi bi-pencil-square' data-toggle='modal' data-target='#edit$id' aria-hidden='true'></i>
										</a>
