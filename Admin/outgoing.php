...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO document_data(reference_id, n_add, n_send, u_address, u_document, u_dor, u_filing, u_sub, u_unit, image,uploaded) VALUES ('$reference_id','$n_add','$n_send','$u_address','$u_document','$u_dor','$u_filing','$u_sub','$u_unit','$image',NOW())";
			...
			<h2 class="mb-4 dashboard">Outgoing Documents</h2>
					...
					<table class="table table-striped table-hover table-responsive-md" id="myTable">
						...
						<?php
							...
							$get_data = "SELECT * FROM document_data WHERE u_document = 'Outgoing'";
								...
								<tr>
									...
									<td class='text-center actions' style='display:flex; align-items: center; justify-content: center; '>
										<span>
											...
											<a href='../Admin/Download/index.php' class='btn btn-info mr-1 Download' title='Download' style='margin-bottom: 5px; display: none; '>
